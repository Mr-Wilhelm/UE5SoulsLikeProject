...
// End Cross Module References
	DEFINE_FUNCTION(UCombatComponent::execResetAttack)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ResetAttack();
	...
	void UCombatComponent::StaticRegisterNativesUCombatComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "ResetAttack", &UCombatComponent::execResetAttack },
		};
	...
	struct Z_Construct_UFunction_UCombatComponent_ResetAttack_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCombatComponent_ResetAttack_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Combat/CombatComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCombatComponent_ResetAttack_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCombatComponent, nullptr, "ResetAttack", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCombatComponent_ResetAttack_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCombatComponent_ResetAttack_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_UCombatComponent_ResetAttack()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCombatComponent_ResetAttack_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCombatComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UCombatComponent_ResetAttack, "ResetAttack" }, // 960120554
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PersonalProjects_UE5_SoulsLike_UE5SoulsLikeProject_SoulsProject_Source_SoulsProject_Public_Combat_CombatComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCombatComponent, UCombatComponent::StaticClass, TEXT("UCombatComponent"), &Z_Registration_Info_UClass_UCombatComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCombatComponent), 3774805035U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PersonalProjects_UE5_SoulsLike_UE5SoulsLikeProject_SoulsProject_Source_SoulsProject_Public_Combat_CombatComponent_h_3749465753(TEXT("/Script/SoulsProject"),
